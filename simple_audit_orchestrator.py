"""
Simple Audit Orchestrator - Lightweight version using simple search agent
"""
...
# Update the import in auditor_agent to use simple search
import sys
sys.modules['search_agent'] = sys.modules['simple_search_agent']

class SimpleAuditOrchestrator:
    def __init__(self, output_dir: str = "Output", report_dir: str = "Report"):
        ...
        self.search_agent = SimpleSearchAgent(output_dir)
...
def main():
    ...
    print("ISO 27001 Multi-Agent Audit System (Simple Version)")
    print("=" * 55)
    
    try:
        # Initialize orchestrator
        orchestrator = SimpleAuditOrchestrator()
